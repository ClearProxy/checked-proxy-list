# ClearProxy.io Checked Proxy List
...
All proxies are now tested against **6 popular websites** to ensure they work with specific services.
...
|-----------|------|--------|--------|
| HTTP | `http/` | ✅ Checked | 519 |
| SOCKS4 | `socks4/` | ✅ Checked | 198 |
| SOCKS5 | `socks5/` | ✅ Checked | 261 |
...
### Top 10 Countries
`1. US (446), 2. ID (52), 3. DE (41), 4. CN (38), 5. GB (30), 6. HK (29), 7. JP (29), 8. SG (26), 9. KR (22), 10. RU (16)`

### Top 10 ASN
`1. ASN22773 (168), 2. ASN45102 (156), 3. ASN46562 (120), 4. ASN14061 (26), 5. ASN8075 (19), 6. ASN20081 (18), 7. ASN4837 (16), 8. ASN6181 (14), 9. ASN24940 (13), 10. ASN37204 (11)`
