...
|-----------|------|--------|--------|
| HTTP | `http/` | ✅ Checked | 231 |
| SOCKS4 | `socks4/` | ✅ Checked | 68 |
| SOCKS5 | `socks5/` | ✅ Checked | 63 |

---

### Top 10 Countries
`1. US (134), 2. Unknown (64), 3. KR (13), 4. DE (12), 5. AR (12), 6. NL (12), 7. CN (12), 8. ID (11), 9. FR (9), 10. SG (9)`

### Top 10 ASN
`1. ASNUnknown (64), 2. ASN46562 (34), 3. ASN22773 (32), 4. ASN14061 (27), 5. ASN39832 (16), 6. ASN45102 (16), 7. ASN4766 (11), 8. ASN265763 (11), 9. ASN40034 (10), 10. ASN16509 (8)`
